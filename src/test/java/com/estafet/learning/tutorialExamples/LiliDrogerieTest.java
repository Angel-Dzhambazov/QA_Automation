package com.estafet.learning.tutorialExamples;

import java.util.List;
import java.util.concurrent.TimeUnit;

import com.estafet.learning.tutorialExamples.pages.LiliShopPage;
...
public class LiliDrogerieTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.get("https://shop.lillydrogerie.bg/");

//        driver.navigate().to("https://shop.demoqa.com/?s=" + "dress" + "&post_type=product");

        WebElement cookiesAccept = LiliShopPage.acceptCookies(driver);
        cookiesAccept.click();
